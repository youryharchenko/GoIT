...
class ExtendedSelectionMode(Mode):
    ...
    def __init__(self):
        ...
        self.action_select_word = QtGui.QAction(self.editor)
        ...
        self.action_select_extended_word = QtGui.QAction(self.editor)
        ...
        self.action_select_matched = QtGui.QAction(self.editor)
        ...
        self.action_select_line = QtGui.QAction(self.editor)
