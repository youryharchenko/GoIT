...
class AutoCompleteMode(Mode):
    ...
    def _on_post_key_pressed(self, event):
        if not event.isAccepted() and not self._ignore_post:
            ...
            trav.movePosition(QtGui.QTextCursor.MoveOperation.Left, 
                            QtGui.QTextCursor.MoveMode.MoveAnchor, 2)
    ...
    def _on_key_pressed(self, event):
        ...
        if event.key() == QtCore.Qt.Key_Backspace:
            ...
            tc.movePosition(QtGui.QTextCursor.MoveOperation.Right, QtGui.QTextCursor.MoveMode.KeepAnchor)
