...
class TextHelper(object):
    ...
    def goto_line(self, line, column=0, move=True):
        ...
        if column:
            text_cursor.movePosition(QtGui.QTextCursor.MoveOperation.Right, QtGui.QTextCursor.MoveMode.MoveAnchor,
                                     column)
        if move:
    ...
    def word_under_cursor(self, select_whole_word=False, text_cursor=None):
        ...
        while not text_cursor.atStart():
            text_cursor.movePosition(
                QtGui.QTextCursor.MoveOperation.Left, QtGui.QTextCursor.MoveMode.KeepAnchor, 1)
            try:
        ...
        if select_whole_word:
            ...
            while not text_cursor.atEnd():
                text_cursor.movePosition(QtGui.QTextCursor.MoveOperation.Right,
                                        QtGui.QTextCursor.MoveMode.KeepAnchor, 1)
                char = text_cursor.selectedText()[0]
                selected_txt = text_cursor.selectedText()
                if (selected_txt in word_separators and
                        (selected_txt != "n" and selected_txt != "t") or
        ...
        text_cursor.setPosition(start_pos)
        text_cursor.setPosition(end_pos, QtGui.QTextCursor.MoveMode.KeepAnchor)
        return text_cursor
    ...
    def select_lines(self, start=0, end=-1, apply_selection=True,
        ...
        if select_blocks:
            move_start = QtGui.QTextCursor.MoveOperation.StartOfBlock
            move_end = QtGui.QTextCursor.MoveOperation.EndOfBlock
            move_up = QtGui.QTextCursor.MoveOperation.PreviousBlock
            move_down = QtGui.QTextCursor.MoveOperation.NextBlock
        else:
            move_start = QtGui.QTextCursor.MoveOperation.StartOfLine
            move_end = QtGui.QTextCursor.MoveOperation.EndOfLine
            move_up = QtGui.QTextCursor.MoveOperation.Up
            move_down = QtGui.QTextCursor.MoveOperation.Down
        if end > start:  # Going down
            text_cursor.movePosition(move_down,
                                    QtGui.QTextCursor.MoveMode.KeepAnchor, end - start)
            ...
            text_cursor.movePosition(move_up,
                                    QtGui.QTextCursor.MoveMode.KeepAnchor, start - end)
    ...
    def mark_whole_doc_dirty(self):
        ...
        text_cursor.select(QtGui.QTextCursor.SelectionType.Document)
    ...
    def get_right_word(self, cursor=None):
        ...
        if cursor is None:
            cursor = self._editor.textCursor()
        cursor.movePosition(QtGui.QTextCursor.MoveOperation.WordRight,
                            QtGui.QTextCursor.MoveMode.KeepAnchor)
    ...
    def insert_text(self, text, keep_position=True):
        ...
        if keep_position:
            ...
            text_cursor.setPosition(e, QtGui.QTextCursor.MoveMode.KeepAnchor)
        self._editor.setTextCursor(text_cursor)
    ...
    def move_right(self, keep_anchor=False, nb_chars=1):
        ...
        text_cursor = self._editor.textCursor()
        text_cursor.movePosition(
            QtGui.QTextCursor.MoveOperation.Right, QtGui.QTextCursor.MoveMode.KeepAnchor if keep_anchor else
            QtGui.QTextCursor.MoveMode.MoveAnchor, nb_chars)
        self._editor.setTextCursor(text_cursor)
    ...
    def is_comment_or_string(self, cursor_or_block, formats=None):
        ...
        if layout is not None:
            additional_formats = layout.formats() #additionalFormats()
    ...
    def select_extended_word(self, continuation_chars=('.',)):
        ...
        while not stop:
            ...
            cursor.movePosition(QtGui.QTextCursor.MoveOperation.Left, QtGui.QTextCursor.MoveMode.KeepAnchor)
    ...
    def match_select(self, ignored_symbols=None):
        ...
        def find_opening_symbol(cursor, matching):
            ...
            while not stop and not cursor.atStart():
                cursor.clearSelection()
                cursor.movePosition(cursor.Left, QtGui.QTextCursor.MoveMode.KeepAnchor)
                char = cursor.selectedText()
...
def get_block_symbol_data(editor, block):
    ...
    def list_symbols(editor, block, character):
        ...
        cursor.movePosition(QtGui.QTextCursor.MoveOperation.Right, 
                            QtGui.QTextCursor.MoveMode.MoveAnchor, pos)
        ...
        while pos != -1:
            ...
            cursor.movePosition(QtGui.QTextCursor.MoveOperation.StartOfBlock)
            cursor.movePosition(QtGui.QTextCursor.MoveOperation.Right, QtGui.QTextCursor.MoveMode.MoveAnchor, pos)
        return symbols
